...
my $saml3 = Google::SAML::Request->new_from_cgi();

is( $saml3->ProviderName,                'google.com', 'ProviderName accessor works' );
is( $saml3->AssertionConsumerServiceURL, 'https://www.google.com/hosted/psosamldemo.net/acs', 'AssertionConsumerServiceURL accessor works' );
is( $saml3->ID,                          'fpagejpkbhmddfodlbmnfhdginimekieckijbeei', 'ID accessor works' );
is( $saml3->IssueInstant,                '2006-05-02T08:49:40Z', 'IssueInstant accessor works' );
